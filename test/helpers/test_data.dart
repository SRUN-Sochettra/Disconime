...
class TestData {
  ...
  static const Anime animeMovie = Anime(
    malId: 100,
    title: 'Test Movie',
    imageUrl: 'https://example.com/movie.jpg',
    type: 'Movie',
    score: Score(value: 8.0),
    synopsis: Synopsis(text: 'A movie.'),
    genres: ['Action'],
    year: '2020',
  );
  ...
  static List<Anime> get animeList => [naruto, fmab, animeNoScore];
  ...
  // ── Character fixtures ────────────────────────────────────────
  // Used by AnimeCharacter.fromJson (per-anime endpoint structure)
  ...
  // Used by TopCharacter.fromJson (top characters endpoint — root level)
  static Map<String, dynamic> get topCharacterJson => {
    ...
    'images': {
      'jpg': {
        'image_url': 'https://example.com/naruto_char.jpg',
        'large_image_url': 'https://example.com/naruto_char_large.jpg',
      }
    },
    'favorites': 50000,
    'anime': [
  ...
  static Map<String, dynamic> get genreJson2 => {
    'mal_id': 2,
    'name': 'Adventure',
    'count': 3000,
